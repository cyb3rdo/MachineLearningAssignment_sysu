...
python main.py --model_name WideDeep --lr 5e-4 --l2 0 --dropout 0.5 --layers "[64,64,64]" --dataset MINDCTR --path ../data/MIND_Small --num_neg 0 --batch_size 1024 --metric AUC --include_item_features 1 --include_situation_features 1 --model_mode CTR --loss_n BCE
